    ...
    constructPrimaryConfigurationSchema() {
        return {
            ...
            bot: {
                ...
                ownerIds: ["328152058869972994"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/xDN3eSyfqU",    // 👈 Your support server link
                defaultStatus: "🎵 Gata De Distractie!"         // 👈 Bot status message
            },
